    ...
    <div className={styles.page}>
      ...
      <header className={styles.topBar}>
        <div className={styles.brand}>
          ...
          <span className={styles.brandName}>TaskMind</span>
      ...
      {planInfo.totalCount > 0 && (
        <div className={styles.progressSection}>
          <div className={styles.progressLabel}>
            <span>Today&apos;s Progress — {selectedEmployeeName}</span>
      ...
      <div className={styles.chatArea}>
        {messages.length === 0 && !selectedEmployee && (
          <div className={styles.emptyState}>
            ...
            <h2>Welcome to TaskMind</h2>
            <p>Select an employee above to start the daily check-in</p>
          </div>
        )}
